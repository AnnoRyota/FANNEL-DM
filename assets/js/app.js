      ...
      if ("string" == typeof s) {
        ...
        if (d.indexOf("<") >= 0 && d.indexOf(">") >= 0) {
          ...
          for (
            o =
            a || "#" !== s[0] || s.match(/[ .<>:~]/) ?
            (a || e).querySelectorAll(s.trim()) : [e.getElementById(s.trim().split("#")[1])],
            n = 0; n < o.length; n += 1
          )
            o[n] && r.push(o[n]);
  ...
  var n = {
      ...
      extend: function () {
        ...
        for (var i = Object(e[0]), s = 1; s < e.length; s += 1) {
          ...
          if (null != a)
            for (
              var r = Object.keys(Object(a)), o = 0, l = r.length; o < l; o += 1
            ) {
              var d = r[o],
  ...
  function A(e) {
    ...
    if (
      ...
      if (s.freeMode) {
        ...
        for (
          var k = 0, $ = t.slidesSizesGrid[0], L = 0; L < l.length; L += s.slidesPerGroup
        )
          ...
          var showMoreButton = $("<div />", {
            ...
            click: function () {
              ...
              if (element.css('max-height') != 'none') {
                element.css('height', settings.minheight).css('max-height', '').animate({
                  height: fullheight
...
$('#post-line').showMore({
  minheight: 183,
  buttontxtmore: '紹介文の続きを見る...',
  buttontxtless: '...紹介文を閉じる',
...
$(function () {
  ...
  $(".open-login").on("click", function () {
    $body.toggleClass("opl");
    $(".close-login").on("click", function () {
      $body.removeClass("opl");
    });
  });
});
...
$(function () {
  ...
  $(".open-edit").on("click", function () {
    $body.toggleClass("opedit");
    $(".close-edit").on("click", function () {
      $body.removeClass("opedit");
    });
  });
});
...
//coin range slider & popup mega-pop
//body
$(function () {
  var $body = $("body");
  $(".open-m").on("click", function () {
...
$('#showcheck').click(function () {
  $("#showcheck-box").toggle(this.checked);
});

$('#showcheck2').click(function () {
  $("#showcheck-box2").toggle(this.checked);
});

$('#membership-first').click(function () {
  $("#showcheck-membership-first").toggle(this.checked);
});


$('#prise1').click(function () {
  $("#show-prise1").toggle(this.checked);
});

$('#prise2').click(function () {
  $("#show-prise2").toggle(this.checked);
});

$('#prise3').click(function () {
  $("#show-prise3").toggle(this.checked);
});

$('#prise4').click(function () {
  $("#show-prise4").toggle(this.checked);
});
...
//coin slider
var slider = document.getElementById("coinRange");
...
//end coin range slider & popup mega-pop
